...
> **Current Version**：`2.3.x.20240823.RELEASE`<br>
> **JDK Baseline**：`17`<br>
...
| JDK | `17` |
| Coordinates | `io.github.easy4j:playwright-spring-boot-starter:2.3.x.20240823.RELEASE` |
...
| `BrowserContextPool` bean | ✅ Stable | Auto-registered via PlaywrightAutoConfiguration |
